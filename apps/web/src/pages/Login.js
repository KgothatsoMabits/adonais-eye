...
export const Login = () => {
    ...
    return (_jsxs("div", { className: "flex-1 flex flex-col bg-transparent px-6 py-6 h-full overflow-y-auto custom-scrollbar w-full max-w-md mx-auto", children: [_jsxs("button", { onClick: () => navigate(-1), className: "flex items-center text-brand-dark font-medium mb-4 mt-2 w-fit hover:opacity-80", children: [_jsx(ChevronLeft, { className: "w-5 h-5 mr-1" }), "Back"] }), _jsxs("div", { className: "mb-6 px-1", children: [_jsx("h1", { className: "text-[34px] font-bold text-brand-dark leading-tight tracking-tight mb-2", children: "Welcome back" }), _jsx("p", { className: "text-gray-500 text-[16px]", children: "Log in to your e-SAPS account to continue." })] }), _jsxs("form", { onSubmit: handleLogin, className: "flex flex-col gap-4 flex-1 pb-4", children: [_jsxs("div", { className: "flex p-1 bg-gray-100 rounded-xl mb-2", children: [_jsx("button", { type: "button", className: `flex-1 py-3 text-[14px] font-semibold rounded-lg transition-all ${loginMethod === 'email'
