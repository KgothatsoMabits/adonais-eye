    ...
    >
      <form onSubmit={handleLogin} className="flex flex-col gap-4 flex-1">
        <div className="flex p-1 bg-gray-100 rounded-xl mb-2">
          <button
            type="button"
            className={`flex-1 py-3 text-[14px] font-semibold rounded-lg transition-all ${
              loginMethod === 'email' 
      ...
      <div className="mt-auto text-center pb-4 flex flex-col items-center gap-4">
        ...
        <button 
          ...
          className="text-[13px] text-gray-400 font-semibold border border-gray-200 px-4 py-2 rounded-full hover:bg-gray-50 transition-colors w-fit mx-auto"
        >
          Skip (Dev Bypass)
        </button>
      </div>
